...
class AdminUpravljanjeUslugamaScreen extends StatefulWidget {
  const AdminUpravljanjeUslugamaScreen({super.key});

  @override
  State<AdminUpravljanjeUslugamaScreen> createState() =>
      _AdminUpravljanjeUslugamaScreenState();
}

class _AdminUpravljanjeUslugamaScreenState
    extends State<AdminUpravljanjeUslugamaScreen> {
          ...
          ElevatedButton(
            onPressed: () async {
              var result = await Navigator.of(context).push(MaterialPageRoute(
                builder: (_) => const AdminUrediDodajUsluguScreen(),
              ));
              if (result == true) {
                ...
                await showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      ...
                      content: const Text("Usluga je uspješno dodana."),
                      actions: [
                        ElevatedButton(
            ...
            await showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  ...
                  content: const Text("Usluga je uspješno uređena."),
                  actions: [
                    ElevatedButton(
                      onPressed: () => Navigator.of(context).pop(),
                      style: ElevatedButton.styleFrom(
                  ...
                  await showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: const Text("Usluga je uspješno obrisana."),
                        actions: [
                          ElevatedButton(
                            onPressed: () => Navigator.of(context).pop(),
                            style: ElevatedButton.styleFrom(
